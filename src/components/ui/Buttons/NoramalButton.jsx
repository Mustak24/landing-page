...
export default function NormalButton({ children, isLoading = false, loadingInnerHTML = 'Wait ...', className = '', text = 'black', bg = 'white', title = 'Click', onClick = () => { }, disabled = false }) {
