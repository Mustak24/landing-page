...
import SlidingTextOnVisible from "../ui/Texts/SlidingTextOnVisible";

export default function HeroSection() {
    return (
        <main id="hero" className="w-full sm:px-5 px-2 pt-12" >
            <div className="relative w-full flex flex-col items-center pt-10 px-2 sm:px-10 rounded-xl overflow-hidden shadow-[0_0_0_1px_rgb(0,0,0,0.2)]" >
                ...
                <div className="text-center text-4xl font-semibold relative">
                    <SlidingTextOnVisible
                        text={'Think, plan, and track'}
                    />
                ...
                <div className="mt-5 flex gap-4 items-center flex-wrap w-full justify-center" >
                    <div className="fade-center-animation" >
                        <RoundedButton
    ...
    return (
        <div className="flex items-center gap-2 overflow-hidden" >
            ...
            <div className="relative flex items-center overflow-hidden" >
                <p style={{ opacity: isDone ? 0.6 : 1 }} className="px-1 text-nowrap">{text}</p>
